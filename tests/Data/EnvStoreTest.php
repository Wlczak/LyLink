...
class EnvStoreTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testStmpHost(string $stmp_host, bool $expectedToFail): void
    {
        ...
        $env = new EnvStore(stmp_host: $stmp_host, stmp_username: 'test@test.test', stmp_password: 'test');
    ...
    public function testEmail(string $email, bool $expectedToFail): void
    {
        ...
        $env = new EnvStore(stmp_host: 'stmp.test.test', stmp_username: $email, stmp_password: 'test');
    ...
    public function testPassword(string $password, bool $expectedToFail): void
    {
        ...
        $env = new EnvStore(stmp_host: 'stmp.test.test', stmp_username: 'test@test.test', stmp_password: $password);
